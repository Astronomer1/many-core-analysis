...
Scorer::Scorer(int UD)
# define consUD 1 // for ascending scheduling of consumption scores
# define prodUD -1 // for descending scheduling of production scores
...
//    }
...

    {
...

		{
		 ...
		 valueResult = (double) inRate / outRate * valueResult;
		...
		valueResult = (double) outRate / inRate * valueResult;
